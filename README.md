...
[![version](https://img.shields.io/badge/version-4.0.0-blue.svg)](https://github.com/Lorenzo-SF/Apero)
...
key = Apero.Crypto.generate_key()                          # 32-byte AES key
{:ok, ct} = Apero.Crypto.encrypt("secret", key)           # AES-256-GCM
